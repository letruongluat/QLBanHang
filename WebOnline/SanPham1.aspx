<%@ Page Title="" Language="C#" MasterPageFile="~/web.Master" AutoEventWireup="true" CodeBehind="SanPham1.aspx.cs" Inherits="WebOnline.SanPham1" %>
        ...
        <asp:DataList ID="dl_loaiSP" runat="server" RepeatDirection="Horizontal" RepeatColumns="3" Width="80%" style="margin-left: 200px;">
            <ItemTemplate>
                <div class="product-item">
                    ...
                    <!-- Ví dụ với nút Button1 -->
<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Mua Hàng" CommandArgument='<%# Eval("MaSV") + ";" + Eval("TenSP") + ";" + Eval("HinhAnh") + ";" + Eval("DonGia") %>' />

                    <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="anh/giohang.png" Width="30px" CommandArgument='<%# Eval("MaSV") + ";" + Eval("TenSP") + ";" + Eval("HinhAnh") + ";" + Eval("DonGia") %>' OnClick="ImageButton1_Click"/>
                    <br />     
                </div><br /><br /><br />
            </ItemTemplate>
        </asp:DataList>
